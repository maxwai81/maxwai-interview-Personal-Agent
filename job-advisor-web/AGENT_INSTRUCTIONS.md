...
- Tell the user: "Report saved. Refresh the Dashboard to view." When reporting links for **GitHub Pages**, use the full HTTPS URL: **`https://maxwai81.github.io/maxwai-interview-Personal-Agent/job-advisor-web/`** for the main app, and **`https://maxwai81.github.io/maxwai-interview-Personal-Agent/job-advisor-web/runs/<slug>/dashboard.html`** for each new per-run `dashboard.html` (replace `<slug>` with the run folder name).
